...
if(obj_pattern_viewer.cur_depth == 0) {
	...
	if(obj_pattern_viewer.splits[po.bt_spr, obj_pattern_viewer.cur_lay] < 0) obj_pattern_viewer.splits[po.bt_spr, obj_pattern_viewer.cur_lay] = array_length_1d(obj_pattern_viewer.bt_sprs) - 1;	
}