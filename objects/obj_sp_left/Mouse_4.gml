...
if((spl ? obj_pattern_viewer.splits[po.bt_spawn, obj_pattern_viewer.cur_lay] < 0 : obj_pattern_viewer.vars[po.bt_spawn, obj_pattern_viewer.cur_lay] ) < 0) { 
	if(spl) obj_pattern_viewer.splits[po.bt_spawn, obj_pattern_viewer.cur_lay] = sp.length-1;
	else obj_pattern_viewer.vars[po.bt_mov, obj_pattern_viewer.cur_lay] = sp.length-1;
}
