...
if(obj_pattern_viewer.cur_depth == 0) {
	...
	if(obj_pattern_viewer.cur_lay == obj_pattern_viewer.layers) obj_pattern_viewer.cur_lay = 0;
}
else {
	...
	if(findIndex(sp_id, obj_pattern_viewer.cur_lay) == array_length_1d(sp_id)-1) {
		obj_pattern_viewer.cur_lay = sp_id[0];	
	}
	else {
