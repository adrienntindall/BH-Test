...
switch(sp_pat) {
	case sp.arc_spread:
		spawn_arc_spread(n, obj_pattern_bullet, id, theta0, theta, sp_r, cd);
		break;
	case sp.circular:
		spawn_circular(n, obj_pattern_bullet, id, theta0, sp_r);
		break;
	case sp.circular_spray:
		spawn_circular_spray(theta, obj_pattern_bullet, id, theta0, sp_r, cd);
		break;
	case sp.line_spread:
		spawn_line_spread(n, obj_pattern_bullet, id, sp_x1, sp_y1, sp_x2, sp_y2,theta0, cd);
		break;
	default:
